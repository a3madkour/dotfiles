...
;; P3.1: frontmatter-render stack shared via `a3madkour-publish-yaml' (the
;; B.4 follow-up #3 IOU, finally collapsed).  Poetry = plain value renderer +
;; the `tags: []' key-hook, same as essays.
