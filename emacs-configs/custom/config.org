  ...
  (let ((destination (completing-read "Where does this go? "
    ...
    (cond
     ...
     ((string= destination "someday")
      (org-todo "")
      (org-refile nil nil
                  (list "Someday" "~/gtd/someday.org" nil
                        (with-current-buffer (find-file-noselect "~/gtd/someday.org")
                          (point-max))))
        ...
        (if is-habit
            (let* ((frequency (completing-read "How often? "
              ...
              (org-schedule nil (format "<%s %s>"
                                        ...
                                        full-repeater))
              (org-refile nil nil
                          (list "Recurring / Habits" "~/gtd/actions.org" nil nil)))
          ;; Regular one-off action
          (a3madkour/set-task-properties)
          (when (yes-or-no-p "Schedule it? ")
            (org-schedule nil))
          (org-refile nil nil
                      (list "Actions" "~/gtd/actions.org" nil nil)))
        ...
        (if (string= project-action "create new project")
          ...
          (org-refile nil nil
                      (org-refile-get-location "Refile to project"
                                                (find-file-noselect "~/gtd/projects.org")))))
