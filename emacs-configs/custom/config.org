...
#+begin_src emacs-lisp
(defun a3madkour/org-in-math-p ()
  "Return non-nil if point is inside a LaTeX math context in org-mode."
  (or (texmathp)
...
(use-package laas
  ...
  (defun a3madkour/laas-set-org-cond ()
    "Use org-aware math detection when in org-mode."
    (when (derived-mode-p 'org-mode)
      (aas-set-snippets 'laas-mode
        :cond #'a3madkour/org-in-math-p)))
  (add-hook 'org-mode-hook #'a3madkour/laas-set-org-cond)
  (aas-set-snippets 'laas-mode
                    ;; set condition!
                    :cond #'texmathp ; expand only while in math
                    "supp" "\\supp"
