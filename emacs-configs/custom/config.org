        ...
        (if is-habit
            (let* ((frequency (completing-read "How often? "
              ...
              (org-schedule nil (format "<%s %s>"
                                        ...
                                        full-repeater))
              (org-refile nil nil
                          (list "Recurring / Habits" "~/org/actions.org" nil nil)))
          ;; Regular one-off action
          (a3madkour/set-task-properties)
          (when (yes-or-no-p "Schedule it? ")
            (org-schedule nil))
          (org-refile nil nil
                      (list "Actions" "~/org/actions.org" nil nil)))
     ...
     ((string= destination "project")
      (let ((project-action (completing-read "Which project? "
        ...
        (if (string= project-action "create new project")
          ...
          (a3madkour/set-task-properties)
          (org-refile nil nil
                      (org-refile-get-location "Refile to project"
                                                (find-file-noselect "~/org/projects.org")))
