...
#+begin_src emacs-lisp
  (general-define-key
   ...
   ;; Defaults
   "d" '(nil  :which-key "defaults")
   "dp" '((lambda () (interactive) (persp-state-load "~/default-persp")) :which-key "load default persp")
   ;; Quit
   ...
   "hc" '(describe-char :which-key "des. character")
   ...
   "sd" '(consult-dash :which-key "search docsets")
   "sl" '(org-store-link :which-key "org-store-link")
   "sr" '(a3madkour/store-region-lines-to-register :which-key "store-region-to-register 1")
   "sf" '(org-ql-find :which-key "org-ql-find")
   "sa" '(org-ql-find-in-agenda :which-key "org-ql in agenda")
   "ss" '(org-ql-search :which-key "org-ql search")
   ;; org ql views
   "v" '(nil :which-key "ql views")
   "vv" '(org-ql-view :which-key "org ql views")
   "vs" '(org-ql-view-sidebar :which-key "org ql view sidebar")
   ;; Windows
   ...
   "rt" '(org-roam-dailies-goto-today :which-key "Goto today")
   ...
   "pv" '(projectile-run-vterm-other-window :which-key "projectile-run-vterm-other-window")
   ...
   "ic" '(org-chef-insert-recipe :which-key "Org Chef Insert Recipe")
   "is" '(yas-insert-snippet :which-key "Snippet")
   "iu" '(insert-char :which-key "Unicode")
   "il" '(org-insert-link :which-key "Org-insert-link")
   "it" '(a3madkour/add-transclusion-from-link :which-key "Insert transclude based on link")
