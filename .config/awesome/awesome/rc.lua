...
-- }}}
-- Enable hotkeys help widger for VIM and other apps
...
local browser      = "brave"
-- Needs an running emacs server
local gui_editor    = "emacsclient -nc -a=''"
local scrlocker    = "light-locker-command -l"
local screenshot_tool = "deepin-screenshot"
...
globalkeys = table_join(
    ...
    awful.key({ altkey, modkey }, "p", function() awful.spawn(screenshot_tool) end,
    ...
    awful.key({ altkey, modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
              {description = "view  previous nonempty", group = "tag"}),
    ...
    -- Control-Super-Alt to change keyboard layout
    awful.key({"Control",altkey, modkey}, "Right", function () kbdcfg.switch_next() end,
   ...
   end,{description = "play", group = "hotkeys"}),
   ...
   awful.key({}, "XF86AudioPrev", function()
    ...
    awful.key({ modkey }, "e", function () awful.spawn("emacs") end,
      {description = "run new emacs instance", group = "launcher"}),
    awful.key({ modkey }, "i", function () awful.spawn.with_shell("doom everywhere") end,
      {description = "run emacs everywhere via doom", group = "launcher"}),
...
awful.spawn.with_shell("feh --randomize --bg-fill ~/Sync/Wallpapers/*")
awful.spawn.with_shell("autorandr --change")
awful.spawn.with_shell("insync start")
awful.spawn("teams", {screen = 1 ,tag = awful.util.tagnames[2] })
awful.spawn("slack", {screen = 1, tag = awful.util.tagnames[2] })
awful.spawn("discord", {screen = 1, tag = awful.util.tagnames[2] })
